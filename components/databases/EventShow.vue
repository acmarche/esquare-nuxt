  ...
  <section>
    <div class="grid grid-cols-1 gap-x-8 lg:grid-cols-2">
      <div class="prose lg:prose-lg">
        <div class="bg-esquare-grey-lighter p-3 m-3" v-if="content">
          <BlockText :property="content"/>
        </div>
        ...
        <div v-if="organisateurs.length > 0">
          ...
          <ul class="flex flex-col" style="padding-inline-start:0.5rem;">
            <li class="flex flex-col items-start mb-3 border-b-esquare-yellow border-b-2"
