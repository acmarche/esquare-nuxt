...
const {status, data, execute, error} =
    useFetch(`${config.public.API_URL}:3000/api/contact`, {
      immediate: false,
      method: 'post',
      watch: false,
        ...
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">
            ...
            <div class="flex gap-x-4">
              ...
              <dd><a class="hover:text-gray-900" href="tel:+32491963365">084/32.70.54</a></dd>
            </div>
            <div class="flex gap-x-4">
              <dt class="flex-none">
      ...
      <form @submit.prevent="handleSubmit" action="#" method="POST" class="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
          ...
          <div class="mt-8 flex justify-end">
            <button type="submit"
                    class="rounded-md bg-esquare-blue px-3.5 py-2.5 text-center font-semibold text-white shadow-sm hover:bg-esquare-yellow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
              Envoyer mon message
            </button>
          </div>
        </div>
